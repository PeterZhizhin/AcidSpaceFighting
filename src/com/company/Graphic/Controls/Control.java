...
public class Control extends Rectangle {
    ...
    public static Color niceGray = new Color(0.06640625f, 0.06640625f, 0.06640625f, 1f);
    protected static Color[] colors;
    protected static Color[] colorsAlphed;
    ...
    public Control(int x, int y, int w, int h) {
        ...
        if (!isInitialised) {
            ...
            colorsAlphed=new Color[gradations];
            ...
            colorsAlphed[0]= Control.niceWhite;
            colors[gradations-1]= Control.niceGray;
            colorsAlphed[gradations-1]=Color.transparent;
